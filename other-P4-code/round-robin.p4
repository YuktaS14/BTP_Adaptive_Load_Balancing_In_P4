        ...
        if (hdr.ipv4.isValid()) {
            ...
            if(meta.routing_metadata.is_int_if == 1){
                ...
                if(flag == 0 ) { // new flow
                    ...
                    //for new flow -> check if its SYN pkt.
                    //for existing flows -> check if you get FIN pkt.
                    ...
                    standard_metadata.egress_spec = (bit<9>)_cur_server_id + (bit<9>)1;
